...
[重庆理工大学-课程攻略共享计划](https://github.com/Royfor12/CQUT-Course-Guide-Sharing-Scheme)

计算机类书籍:  
[值得一看的技术类书籍列表](https://book.doocs.org/)  
...
git仓库维护:
[一键生成贡献图](https://contrib.rocks)  
[一键生成start图](https://star-history.com)  